...
int geek()//void getGyroscopeData(int * result)
{
  /**************************************
   * gyro ITG- 3200 I2C
   * registersï¼š
...
int x;
int g;
long int jum;//pake long int karena nntnya ada pertambahan yang banyak loh
int iterasi=1;
int tampil;//ini untuk menampilkan di lcd hasil akhir percepatan
void loop()
{
